...
public interface QrcodeDao {
	...
	@Insert("insert into qr_code ( gameId, state, content, link, photo, ossPath,localPath,logicUse) "
			+ "values( #{gameId}, #{state}, #{content}, #{link}, #{photo} , #{ossPath} , #{localPath},#{logicUse})")
	int save(QRCode qr);
